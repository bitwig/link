...
template <typename Clock>
inline void BasicLink<Clock>::commitAudioSessionState(const BasicLink<Clock>::SessionState state)
{
...
template <typename Clock>
inline void BasicLink<Clock>::commitAppSessionState(const BasicLink<Clock>::SessionState state)
{
